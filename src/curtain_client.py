# *Note
# Not using Python gRPC client anymore as the connection between Java gRPC client and python gRPC server has been established and connected. This is the old solution of communication using socket to communicate the Java gRPC client and Python gRPC client
